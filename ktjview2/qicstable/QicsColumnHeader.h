...
#ifndef _QicsColumnHeader_H
#define _QicsColumnHeader_H
...
class QicsColumnHeader: public QicsHeader {
Q_OBJECT
...
#endif /* _QicsColumnHeader_H --- Do not add anything past this line */
