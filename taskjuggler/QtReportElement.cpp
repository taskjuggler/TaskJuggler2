...
void
QtReportElement::generateTableHeader()
{
    // Header line 1
    ...
    for (QPtrListIterator<TableColumnInfo> it(columns); it; ++it )
    {
        ...
        {
            TJMH.errorMessage
                (i18n("Unknown Column '%1' for Qt Report")
                 .arg((*it)->getName()));
            return;
        }
    }
...
void
QtReportElement::generateLine(TableLineInfo* tli, int funcSel)
{
    setMacros(tli);
...
void
QtReportElement::genCell(const QString& text, TableCellInfo* tci,
...
void
QtReportElement::reportTaskLoad(double load, TableCellInfo* tci,
...
void
QtReportElement::reportResourceLoad(double load, TableCellInfo* tci,
                                      const Interval& period)
{
    QString text;
    if (load > 0.0)
...
void
QtReportElement::reportCurrency(double value, TableCellInfo* tci,
                                  time_t iv_start)
{
    tci->setStatusText(time2user(iv_start, "%Y-%m-%d / [") +
                       tci->tli->account->getId() + "] " +
                       tci->tli->account->getName());
    genCell(tci->tcf->realFormat.format(value, tci), tci, FALSE);
}

void
QtReportElement::generateTitle(TableCellInfo* tci, const QString& str)
{
    QStringList* sl = new QStringList();
    sl->append(str);
    QString cellText;
...
void
QtReportElement::generateSubTitle(TableCellInfo* tci, const QString& str)
{
    QStringList* sl = new QStringList();
    sl->append(str);
    QString cellText;
...
void
QtReportElement::generateRightIndented(TableCellInfo* tci, const QString& str)
{
...
void
QtReportElement::genHeadDefault(TableCellInfo* tci)
{
    puts("   <td rowspan=\"2\"");
    puts(">");
...
void
QtReportElement::genHeadCurrency(TableCellInfo* tci)
{
    puts("   <td rowspan=\"2\"");
    puts(">");
    generateTitle(tci, tci->tcf->getTitle() +
...
void
QtReportElement::genHeadDaily1(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadDaily2(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadWeekly1(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadWeekly2(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadMonthly1(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadMonthly2(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadQuarterly1(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadQuarterly2(TableCellInfo* tci)
{
...
void
QtReportElement::genHeadYear(TableCellInfo* tci)
{
    // Generates 1st header line of monthly calendar view.
...
void
QtReportElement::genCellEmpty(TableCellInfo* tci)
{
    genCell("", tci, TRUE);
}

void
QtReportElement::genCellSequenceNo(TableCellInfo* tci)
{
...
void
QtReportElement::genCellNo(TableCellInfo* tci)
{
...
void
QtReportElement::genCellHierarchNo(TableCellInfo* tci)
{
    genCell(tci->tli->ca2 == 0 ?
...
void
QtReportElement::genCellIndex(TableCellInfo* tci)
{
    genCell(tci->tli->ca2 == 0 ?
...
void
QtReportElement::genCellHierarchIndex(TableCellInfo* tci)
{
    genCell(tci->tli->ca2 == 0 ?
...
void
QtReportElement::genCellId(TableCellInfo* tci)
{
    genCell(tci->tli->ca1->getId(), tci, TRUE);
}

void
QtReportElement::genCellName(TableCellInfo* tci)
{
    int lPadding = 0;
...
void
QtReportElement::genCellStart(TableCellInfo* tci)
{
...
void
QtReportElement::genCellEnd(TableCellInfo* tci)
{
...
#define GCMMSE(a, b) \
void \
QtReportElement::genCell##a(TableCellInfo* tci) \
{ \
...
#define GCSEBUFFER(a) \
void \
QtReportElement::genCell##a##Buffer(TableCellInfo* tci) \
{ \
...
void
QtReportElement::genCellStartBufferEnd(TableCellInfo* tci)
{
...
void
QtReportElement::genCellEndBufferStart(TableCellInfo* tci)
{
    genCell(time2user(tci->tli->task->getStartBufferEnd
...
void
QtReportElement::genCellDuration(TableCellInfo* tci)
{
...
void
QtReportElement::genCellEffort(TableCellInfo* tci)
{
    double val = 0.0;
    if (tci->tli->ca1->getType() == CA_Task)
    {
...
void
QtReportElement::genCellCriticalness(TableCellInfo* tci)
{
...
void
QtReportElement::genCellPathCriticalness(TableCellInfo* tci)
{
    generateRightIndented
...
void
QtReportElement::genCellProjectId(TableCellInfo* tci)
{
...
void
QtReportElement::genCellProjectIDs(TableCellInfo* tci)
{
...
void
QtReportElement::genCellResources(TableCellInfo* tci)
{
    QString text;
...
void
QtReportElement::genCellResponsible(TableCellInfo* tci)
{
...
void
QtReportElement::genCellText(TableCellInfo* tci)
{
...
void
QtReportElement::genCellStatusNote(TableCellInfo* tci)
{
...
void
QtReportElement::genCellCost(TableCellInfo* tci)
{
    double val = 0.0;
    if (tci->tli->ca1->getType() == CA_Task)
    {
...
void
QtReportElement::genCellRevenue(TableCellInfo* tci)
{
    double val = 0.0;
    if (tci->tli->ca1->getType() == CA_Task)
    {
...
void
QtReportElement::genCellProfit(TableCellInfo* tci)
{
    double val = 0.0;
    if (tci->tli->ca1->getType() == CA_Task)
    {
...
void
QtReportElement::genCellPriority(TableCellInfo* tci)
{
...
void
QtReportElement::genCellFlags(TableCellInfo* tci)
{
...
void
QtReportElement::genCellCompleted(TableCellInfo* tci)
{
...
void
QtReportElement::genCellStatus(TableCellInfo* tci)
{
    QString text;
...
void
QtReportElement::genCellReference(TableCellInfo* tci)
{
    if (tci->tcf->getId() == "reference")
    {
        ...
        else
        {
            ...
            if (tci->tli->task->getReferenceLabel().isEmpty())
                text += tci->tli->task->getReference();
            else
                text += tci->tli->task->getReferenceLabel();
            text += "</a>";
...
void
QtReportElement::genCellScenario(TableCellInfo* tci)
{
...
QColor
QtReportElement::selectTaskBgColor(TableCellInfo* tci, double load,
...
QColor
QtReportElement::selectResourceBgColor(TableCellInfo* tci, double load,
...
void
QtReportElement::genCellTaskFunc(TableCellInfo* tci, bool daily,
...
void
QtReportElement::genCellResourceFunc(TableCellInfo* tci, bool daily,
                                   time_t (*beginOfT)(time_t),
                                   time_t (*sameTimeNextT)(time_t))
{
    for (time_t t = beginOfT(start); t < end; t = sameTimeNextT(t))
...
void
QtReportElement::genCellAccountFunc(TableCellInfo* tci,
                                      time_t (*beginOfT)(time_t),
                                      time_t (*sameTimeNextT)(time_t))
{
...
void
QtReportElement::genCellDailyTask(TableCellInfo* tci)
{
    genCellTaskFunc(tci, TRUE, midnight, sameTimeNextDay);
}

void
QtReportElement::genCellDailyResource(TableCellInfo* tci)
{
    genCellResourceFunc(tci, TRUE, midnight, sameTimeNextDay);
}

void
QtReportElement::genCellDailyAccount(TableCellInfo* tci)
{
    genCellAccountFunc(tci, midnight, sameTimeNextDay);
}

void
QtReportElement::genCellWeeklyTask(TableCellInfo* tci)
{
    bool weekStartsMonday = report->getWeekStartsMonday();
    for (time_t week = beginOfWeek(start, weekStartsMonday); week < end;
         week = sameTimeNextWeek(week))
...
void
QtReportElement::genCellWeeklyResource(TableCellInfo* tci)
{
    bool weekStartsMonday = report->getWeekStartsMonday();
    for (time_t week = beginOfWeek(start, weekStartsMonday); week < end;
         week = sameTimeNextWeek(week))
...
void
QtReportElement::genCellWeeklyAccount(TableCellInfo* tci)
{
    bool weekStartsMonday = report->getWeekStartsMonday();
    for (time_t week = beginOfWeek(start, weekStartsMonday); week < end;
         week = sameTimeNextWeek(week))
...
void
QtReportElement::genCellMonthlyTask(TableCellInfo* tci)
{
    genCellTaskFunc(tci, FALSE, beginOfMonth, sameTimeNextMonth);
}

void
QtReportElement::genCellMonthlyResource(TableCellInfo* tci)
{
    genCellResourceFunc(tci, FALSE, beginOfMonth, sameTimeNextMonth);
}

void
QtReportElement::genCellMonthlyAccount(TableCellInfo* tci)
{
    genCellAccountFunc(tci, beginOfMonth, sameTimeNextMonth);
}

void
QtReportElement::genCellQuarterlyTask(TableCellInfo* tci)
{
    genCellTaskFunc(tci, FALSE, beginOfQuarter, sameTimeNextQuarter);
}

void
QtReportElement::genCellQuarterlyResource(TableCellInfo* tci)
{
    genCellResourceFunc(tci, FALSE, beginOfQuarter, sameTimeNextQuarter);
}

void
QtReportElement::genCellQuarterlyAccount(TableCellInfo* tci)
{
    genCellAccountFunc(tci, beginOfQuarter, sameTimeNextQuarter);
}

void
QtReportElement::genCellYearlyTask(TableCellInfo* tci)
{
    genCellTaskFunc(tci, FALSE, beginOfYear, sameTimeNextYear);
}

void
QtReportElement::genCellYearlyResource(TableCellInfo* tci)
{
    genCellResourceFunc(tci, FALSE, beginOfYear, sameTimeNextYear);
}

void
QtReportElement::genCellYearlyAccount(TableCellInfo* tci)
{
    genCellAccountFunc(tci, beginOfYear, sameTimeNextYear);
}

void
QtReportElement::genCellResponsibilities(TableCellInfo* tci)
{
    QString text;
...
void
QtReportElement::genCellSchedule(TableCellInfo* tci)
{
    s() << "   <td>" << endl;
...
#define GCEFFORT(a) \
void \
QtReportElement::genCell##a##Effort(TableCellInfo* tci) \
{ \
...
void
QtReportElement::genCellMaxEffort(TableCellInfo* tci)
{
    genCell(tci->tcf->realFormat.format
...
void
QtReportElement::genCellRate(TableCellInfo* tci)
{
...
void
QtReportElement::genCellKotrusId(TableCellInfo* tci)
{
    genCell(tci->tli->resource->getKotrusId(), tci, TRUE);
}

void
QtReportElement::genCellTotal(TableCellInfo* tci)
{
...
void
QtReportElement::genCellSummary(TableCellInfo* tci)
{
